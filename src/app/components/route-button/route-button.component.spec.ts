...
} from './route-button.component';

describe('RouteButtonComponent', () => {
  const testRoute: MoeRoute = new MoeRoute.Builder()
    .setLabel('test')
    .setPath('/test')
    .build();
  ...
  it(
    'should display the correct route label',
    waitForAsync(() => {
  ...
  it(
    'should incorporate the correct path',
    waitForAsync(() => {
      component.route = testRoute;
      fixture.detectChanges();

      expect(
        fixture.nativeElement.querySelector('.moe-route-link').href
      ).toContain('/test');
    })
  );

  it(
    'should apply the BUTTON style by default',
    waitForAsync(() => {
      component.route = testRoute;
      fixture.detectChanges();
  ...
  it(
    'should apply the BUTTON style when specified',
    waitForAsync(() => {
      component.route = testRoute;
  ...
  it(
    'should apply the LINE_ITEM style when specified',
    waitForAsync(() => {
      component.route = testRoute;
      ...
      expect(
        fixture.nativeElement.querySelector('.line-item-style')
      ).toBeTruthy();
    })
  );
});
