...
describe('WeaponCardComponent', () => {
  ...
  it(
    ...
    waitForAsync(() => {
      ...
      expect(
        fixture.nativeElement.querySelector('.weapon-card-name').textContent
  ...
  it(
    ...
    waitForAsync(() => {
      ...
      expect(
        fixture.nativeElement.querySelector('.weapon-base-attack-value')
          .textContent
      ).toContain('0');
    })
  );
  ...
  it(
    ...
    waitForAsync(() => {
      ...
      expect(
        fixture.nativeElement.querySelector('.weapon-substat-attribute')
      ).toBeFalsy();
    })
  );
  ...
  it(
    ...
    waitForAsync(() => {
      ...
      expect(
        fixture.nativeElement.querySelector('.weapon-substat-label').textContent
      ).toContain('ATK %');
      expect(
        fixture.nativeElement.querySelector('.weapon-substat-value').textContent
      ).toContain('100');
    })
  );
