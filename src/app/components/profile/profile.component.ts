...
export class ProfileComponent {
  ...
  testOptions = {
    ...
    vAxis: { gridlines: { count: 0 }, textPosition: 'none', color: 'transparent' },
    chartArea: {width: '100%', height: '100%'},
  };
  pageId?: string;

  constructor(private route: ActivatedRoute, private impactService: ImpactService, public utilityService: UtilityService, public userService: UserService, public authService: AuthService) {
