...
describe('MoeRouteModel', () => {
  it('should configure a valid empty route object', waitForAsync(() => {
  ...
  it('should configure a route with a given path', waitForAsync(() => {
  ...
  it('should configure a route with a given label', waitForAsync(() => {
